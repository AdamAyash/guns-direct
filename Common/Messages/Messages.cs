namespace Common
{
    ...
    public class Messages
    {
        ...
        public const string DIFFERENCE_IN_DOMAIN_OBJECT_FIELDS_AND_TABLE = "Table fields count does not correspond to the domain objects properties.";
        public const string COUNTER_DOES_NO_EXIST_ERROR = "Counter with table {0}, does not exist.";
        public const string COUNTER_ALREADY_UPDATED = "Counter with table {0} is already updated.";
